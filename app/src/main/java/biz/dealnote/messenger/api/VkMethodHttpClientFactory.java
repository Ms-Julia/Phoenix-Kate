...
public class VkMethodHttpClientFactory implements IVkMethodHttpClientFactory {
    ...
    public OkHttpClient createServiceVkHttpClient(Gson gson, ProxyConfig config) {
        return createDefaultVkApiOkHttpClient(new CustomTokenVkApiInterceptor(Constants.SERVICE_TOKEN, Constants.API_VERSION, gson, Account_Types.KATE, null), config);
    }
